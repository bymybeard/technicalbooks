...
public class HitCount extends HttpServlet
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6317681383332888853L;
	private IncrementLocal inc = null;
	private int count = 0;
	...
	synchronized private String getInc(String namespace)
	{
		...
		IncrementLocalHome incHome = null;
		...
		try
		{
			...
			{
				lookupString = "local:ejb/Increment";
			}

			//homeObject = (IncrementHome) ic.lookup(lookupString);
			incHome = (IncrementLocalHome) ic.lookup(lookupString);
		}
		catch (Exception e)
		{
			countFailure = 1;
